...
pr12, u12, du12, e12 = itera(1,0,E1,E3,u0,c,d,yint,mu,r1,step1)
pr112, u112, du112, e112 = itera(1, 1, E11, E13, u0, c,d,yint, mu, r2, step2)
pr202, u202, du202, e202 = itera(2, 0, E01, E03, u0, c,d,yint, mu, r3, step3)
pr212, u212, du212, e212 = itera(2, 1, Ep1, Ep3, u0, c,d,yint, mu, r4, step4)
pr302, u302, du302, e302 = itera(3, 0, E31, E33, u0, c,d,yint, mu, r5, step5)

statement(u12,du12,1,0,r1,e12,norm)
statement(u112,du112,1,1,r2,e112,norm)
statement(u202,du202,2,0,r3,e202,norm)
statement(u212,du212,2,1,r4,e212,norm)
statement(u302,du302,3,0,r3,e302,norm)
...
plt.plot(r1, du1, 'b',label="Gradients from $V_1$")
plt.plot(r1, du12, 'r',label="Gradients from $V_2$")
...
plt.title("Gradients of S states from $V_1$ and $V_2$",fontsize=25)
plt.xlabel("Radial Distance, $GeV^{-1}$",fontsize=25)
plt.ylabel("$du_{nl}(r)$",fontsize=25)
