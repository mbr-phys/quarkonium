...
pr21, u21, du21, E21 = itera(2, 1, Ep1, Ep2, Ep3, u0, alpha, beta1, mu, r4, step4)
pr30, u30, du30, E30 = itera(3, 0, E31, E32, E33, u0, alpha, beta1, mu, r5, step5)

norm = 1
statement(u1,1,0,r1,E1,norm)
statement(u11,1,1,r2,E11,norm)
statement(u20,2,0,r3,E20,norm)
statement(u21,2,1,r4,E21,norm)
statement(u30,3,0,r3,E30,norm)
...
#plt.plot((1,2),(M11,M11),'orange')
#plt.plot((2,3),(M20,M20),'cyan')
#plt.plot((2,3),(M2_3,M2_3),'purple')
#plt.plot((2,3),(M2_1,M2_1),'purple')
#
#plt.plot((0,1),(3.096,3.096),'red')
#plt.plot((0,1),(2.98,2.98),'red')
#plt.plot((2,3),(3.638,3.638),'red')
#plt.plot((2,3),(3.686,3.686),'red')
