...
def itera(n, l, E, u0, alpha, beta1, beta2, beta3, mu, r, step):
    '''
    ...
    while i==0:
        ...
        sol1 = odeint(wavefn, u0, r, args=(a,b,c,d1))
        sol2 = odeint(wavefn, u0, r, args=(a,b,c,d2))
        sol3 = odeint(wavefn, u0, r, args=(a,b,c,d3))
        ...
        pr1, soli1, du1, norm1 = simpson(pr1, soli1, du1, n, l, r)
        pr2, soli2, du2, norm2 = simpson(pr2, soli2, du2, n, l, r)
        pr3, soli3, du3, norm3 = simpson(pr3, soli3, du3, n, l, r)
        ...
        if numbs1 != numbs2 or tps1 != tps2:
            ...
            if numbs1 == (n-1) and tps1 == (n):
                ...
                print "No solution found with E1,2,3 = %.3e, %.3e, %.3e" % (beta1, beta2, beta3)
                delta = beta3 - beta1
                if beta1 != 0:
                    odmag = int(math.floor(math.log10(abs(beta1))))
                elif beta2 != 0:
                    odmag = int(math.floor(math.log10(abs(beta2))))
                elif beta3 != 0:
                    odmag = int(math.floor(math.log10(abs(beta3))))
                else:
